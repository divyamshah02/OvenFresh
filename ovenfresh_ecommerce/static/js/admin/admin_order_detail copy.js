...
async function loadOrderDetails() {
  try {
    ...
    console.log("Order details loaded successfully:", result.data)
...
async function assignDeliveryPerson() {
  ...
  try {
    ...
    console.log("Assign delivery person response:", result)
...
function initializeEventListeners() {
  ...
  // Admin notes auto-save (optional)
  document.getElementById("admin-notes").addEventListener("blur", () => {
